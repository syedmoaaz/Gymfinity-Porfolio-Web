...
//             />
//             <span className="text-xl lg:text-3xl font-extrabold text-gymfinity-400 tracking-tight transition-all duration-300">
//               GymFinity
//             </span>
//           </a>
...
//             <span className="text-2xl lg:text-3xl font-bold text-gymfinity-400 tracking-tight">
//               GymFinity
//             </span>
//           </a>
...
//               target="_blank"
//               rel="noopener noreferrer"
//               className="px-6 py-2 bg-gymfinity-400 text-white text-sm font-semibold rounded-md hover:bg-gymfinity-600 transition duration-300 shadow-sm hover:shadow-md"
//             >
//               Log In
//             </a>
//           </div>
...
//         <div
//           className={`md:hidden transition-all duration-300 overflow-hidden ${
//             isMenuOpen ? "max-h-96 pt-4 pb-6" : "max-h-0"
//           }`}
//         >
...
//                 href={link.href}
//                 onClick={closeMenu}
//                 className="text-base font-medium text-gymfinity-900 hover:text-gymfinity-400 transition"
//               >
//                 {link.name}
//               </a>
//             ))}
...
//               target="_blank"
//               rel="noopener noreferrer"
//               className="mt-2 px-6 py-2 bg-gymfinity-400 text-white text-sm font-semibold rounded-md text-center hover:bg-gymfinity-600 transition"
//             >
//               Log In
//             </a>
//           </div>
